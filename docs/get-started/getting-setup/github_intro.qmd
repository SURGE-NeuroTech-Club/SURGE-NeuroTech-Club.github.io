...
Before you get started here, make sure you already have a GitHub account setup. If you don't head over to [*Getting Setup*](../getting-setup/getting_setup.qmd) for instructions!
